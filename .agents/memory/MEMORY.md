- [share_plus 12.x API](share-plus-v12.md) — deprecated Share.shareXFiles; use SharePlus.instance.share(ShareParams(files:[], subject:)) instead.
- [image 4.x isolate pattern](image-isolate-pattern.md) — all img.decodeImage/encode calls must run via compute(); pass Map<String,dynamic> with Uint8List bytes; return Uint8List.
