...
## Flutter Project (Parts 1 & 2 Complete)

A native Flutter Android app lives at `/csc_smart_toolkit/`.

### Stack
- **Framework:** Flutter 3.32.0, Dart 3.8.0
- **Navigation:** go_router (StatefulShellRoute for persistent bottom tabs)
- **State:** provider (ThemeProvider)
- **Storage:** shared_preferences
- **UI:** Material 3, google_fonts (Inter), flutter_svg
...
csc_smart_toolkit/
  ...
  assets/app_icon.png, splash_logo.png
  android/  ← applicationId: com.csc.smarttoolkit
```

### How to run (on local machine / Android Studio)
```bash
cd csc_smart_toolkit
flutter pub get
